...
pub struct Chip {
    ...
    // @@protoc_insertion_point(field:netsim.startup.Chip.sim_profile)
    pub sim_profile: ::std::option::Option<::std::string::String>,
    // special fields
...
impl Chip {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "sim_profile",
            |m: &Chip| { &m.sim_profile },
            |m: &mut Chip| { &mut m.sim_profile },
        ));
...
impl ::protobuf::Message for Chip {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                98 => {
                    self.sim_profile = ::std::option::Option::Some(is.read_string()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.sim_profile.as_ref() {
    ...
    fn clear(&mut self) {
        ...
        self.offset.clear();
        self.sim_type = 0;
        self.sim_profile = ::std::option::Option::None;
        self.special_fields.clear();
    }
    ...
    fn default_instance() -> &'static Chip {
        static instance: Chip = Chip {
            ...
            sim_type: 0,
            sim_profile: ::std::option::Option::None,
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08\x20\x01(\tR\x07avdPath\"\xc7\x03\n\x04Chip\x12+\n\x04kind\x18\x01\
    ...
    \x05R\x07simType\x12$\n\x0bsim_profile\x18\x0c\x20\x01(\tH\x01R\nsimProf\
    ile\x88\x01\x01B\t\n\x07_offsetB\x0e\n\x0c_sim_profileB#\n\x1fcom.androi\
    d.emulation.bluetoothP\x01J\xbc\x1d\n\x06\x12\x04\x03\0k\x01\n_\n\x01\
    ...
    \x02\x03\x01\x12\x03\x08\0\x1c\n\t\n\x02\x03\x02\x12\x03\t\0'\n\x08\n\
    \x01\x08\x12\x03\x0b\0\"\n\t\n\x02\x08\n\x12\x03\x0b\0\"\n\x08\n\x01\x08\
    \x12\x03\x0c\08\n\t\n\x02\x08\x01\x12\x03\x0c\08\n\x96\x04\n\x02\x04\0\
    \x12\x04%\0/\x012\x89\x04*\n\x20The\x20startup\x20info\x20proto.\n\n\x20\
    When\x20netsim\x20is\x20forked\x20from\x20a\x20parent\x20that\x20owns\
    \x20all\x20fds\x20for\x20HAL\x20communication\n\x20(like\x20launch_cvd)\
    \x20it\x20uses\x20json\x20format\x20of\x20this\x20proto.\n\n\x20Example:\
    \n\n\x20netsim\x20-s\x20'\n\x20\x20\x20{\"devices\":\x20[\n\x20\x20\x20\
    \x20\x20\x20{serial:\x20\"emulator-5554\",\n\x20\x20\x20\x20\x20\x20\x20\
    chips:\x20[{kind:\x20\"WIFI\",\x20fdIn:\x201,\x20fdOut:\x202},\n\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20{kind:\x20\"BLUETOOT\
    H\",\x20fdIn:\x2020,\x20fdOut:21}]\n\x20\x20\x20\x20\x20\x20},\n\x20\x20\
    \x20\x20\x20\x20{serial:\x20\"emulator-5555\",\n\x20\x20\x20\x20\x20\x20\
    \x20chips:\x20[{kind:\x20\"BLUETOOTH\",\x20fdIn:\x203,\x20fdOut:\x204},\
    \n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20{kind:\x20\
    \"UWB\",\x20fdIn:\x205,\x20fdOut:\x206,\x20model:\x20\"DW300\"}]\n\x20\
    \x20\x20\x20\x20\x20}\n\x20\x20\x20\x20]\n\x20\x20\x20}'\n\n\n\n\n\x03\
    \x04\0\x01\x12\x03%\x08\x13\n\x0c\n\x04\x04\0\x03\0\x12\x04&\x02-\x03\n\
    \x0c\n\x05\x04\0\x03\0\x01\x12\x03&\n\x10\nY\n\x06\x04\0\x03\0\x02\0\x12\
    \x03(\x04(\x1aJ\x20Deprecated.\x20Field\x20moved\x20into\x20DeviceInfo.\
    \x20Please\x20use\x20device_info\x20instead.\n\n\x0e\n\x07\x04\0\x03\0\
    \x02\0\x05\x12\x03(\x04\n\n\x0e\n\x07\x04\0\x03\0\x02\0\x01\x12\x03(\x0b\
    \x0f\n\x0e\n\x07\x04\0\x03\0\x02\0\x03\x12\x03(\x12\x13\n\x0e\n\x07\x04\
    \0\x03\0\x02\0\x08\x12\x03(\x14'\n\x0f\n\x08\x04\0\x03\0\x02\0\x08\x03\
    \x12\x03(\x15&\n4\n\x06\x04\0\x03\0\x02\x01\x12\x03*\x04\x1c\x1a%\x20lis\
    t\x20of\x20SoCs\x20associated\x20with\x20device\n\n\x0e\n\x07\x04\0\x03\
    \0\x02\x01\x04\x12\x03*\x04\x0c\n\x0e\n\x07\x04\0\x03\0\x02\x01\x06\x12\
    \x03*\r\x11\n\x0e\n\x07\x04\0\x03\0\x02\x01\x01\x12\x03*\x12\x17\n\x0e\n\
    \x07\x04\0\x03\0\x02\x01\x03\x12\x03*\x1a\x1b\n.\n\x06\x04\0\x03\0\x02\
    \x02\x12\x03,\x04\x1f\x1a\x1f\x20additional\x20device\x20information\n\n\
    \x0e\n\x07\x04\0\x03\0\x02\x02\x06\x12\x03,\x04\x0e\n\x0e\n\x07\x04\0\
    \x03\0\x02\x02\x01\x12\x03,\x0f\x1a\n\x0e\n\x07\x04\0\x03\0\x02\x02\x03\
    \x12\x03,\x1d\x1e\n\x0b\n\x04\x04\0\x02\0\x12\x03.\x02\x1e\n\x0c\n\x05\
    \x04\0\x02\0\x04\x12\x03.\x02\n\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03.\x0b\
    \x11\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03.\x12\x19\n\x0c\n\x05\x04\0\x02\
    \0\x03\x12\x03.\x1c\x1d\n@\n\x02\x04\x01\x12\x043\0<\x01\x1a4\x20TODO:\
    \x20rename\x20to\x20InitialInfo\n\x20InitialInfo\x20over\x20gRPC\n\n\n\n\
    \x03\x04\x01\x01\x12\x033\x08\x10\nW\n\x04\x04\x01\x02\0\x12\x035\x02&\
    \x1aJ\x20Deprecated.\x20Field\x20moved\x20into\x20DeviceInfo.\x20Please\
    \x20use\x20device_info\x20instead.\n\n\x0c\n\x05\x04\x01\x02\0\x05\x12\
    \x035\x02\x08\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x035\t\r\n\x0c\n\x05\x04\
    \x01\x02\0\x03\x12\x035\x10\x11\n\x0c\n\x05\x04\x01\x02\0\x08\x12\x035\
    \x12%\n\r\n\x06\x04\x01\x02\0\x08\x03\x12\x035\x13$\n\x1a\n\x04\x04\x01\
    \x02\x01\x12\x037\x02\x10\x1a\r\x20single\x20chip\n\n\x0c\n\x05\x04\x01\
    \x02\x01\x06\x12\x037\x02\x06\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x037\
    \x07\x0b\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x037\x0e\x0f\n,\n\x04\x04\
    \x01\x02\x02\x12\x039\x02\x1d\x1a\x1f\x20additional\x20device\x20informa\
    tion\n\n\x0c\n\x05\x04\x01\x02\x02\x06\x12\x039\x02\x0c\n\x0c\n\x05\x04\
    \x01\x02\x02\x01\x12\x039\r\x18\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\x039\
    \x1b\x1c\nM\n\x04\x04\x01\x02\x03\x12\x03;\x02\x1d\x1a@\x20True\x20if\
    \x20this\x20connection\x20is\x20a\x20result\x20of\x20a\x20host\x20reconn\
    ect\x20event.\n\n\x0c\n\x05\x04\x01\x02\x03\x05\x12\x03;\x02\x06\n\x0c\n\
    \x05\x04\x01\x02\x03\x01\x12\x03;\x07\x18\n\x0c\n\x05\x04\x01\x02\x03\
    \x03\x12\x03;\x1b\x1c\n\n\n\x02\x04\x02\x12\x04>\0O\x01\n\n\n\x03\x04\
    \x02\x01\x12\x03>\x08\x12\n\x1d\n\x04\x04\x02\x02\0\x12\x03@\x02\x12\x1a\
    \x10\x20Name\x20of\x20device\n\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03@\
    \x02\x08\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03@\t\r\n\x0c\n\x05\x04\x02\
    \x02\0\x03\x12\x03@\x10\x11\nP\n\x04\x04\x02\x02\x01\x12\x03B\x02\x12\
    \x1aC\x20Identifier\x20for\x20device\x20kind\x20e.g.\x20EMULATOR,\x20CUT\
    TLEFISH,\x20BUMBLE,\x20etc\n\n\x0c\n\x05\x04\x02\x02\x01\x05\x12\x03B\
    \x02\x08\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03B\t\r\n\x0c\n\x05\x04\
    \x02\x02\x01\x03\x12\x03B\x10\x11\nV\n\x04\x04\x02\x02\x02\x12\x03D\x02\
    \x15\x1aI\x20Version\x20info\x20as\x20applicable\x20e.g.\x20Android\x20e\
    mulator\x20version\x2034.1.15.0,\x20etc\n\n\x0c\n\x05\x04\x02\x02\x02\
    \x05\x12\x03D\x02\x08\n\x0c\n\x05\x04\x02\x02\x02\x01\x12\x03D\t\x10\n\
    \x0c\n\x05\x04\x02\x02\x02\x03\x12\x03D\x13\x14\n>\n\x04\x04\x02\x02\x03\
    \x12\x03F\x02\x19\x1a1\x20SDK\x20version\x20info\x20as\x20applicable\x20\
    e.g.\x2033,\x2034,\x20etc\n\n\x0c\n\x05\x04\x02\x02\x03\x05\x12\x03F\x02\
    \x08\n\x0c\n\x05\x04\x02\x02\x03\x01\x12\x03F\t\x14\n\x0c\n\x05\x04\x02\
    \x02\x03\x03\x12\x03F\x17\x18\nB\n\x04\x04\x02\x02\x04\x12\x03H\x02\x16\
    \x1a5\x20Build\x20ID\x20e.g.\x20TE1A.220922.034,\x20UQ1A.231205.015,\x20\
    etc\n\n\x0c\n\x05\x04\x02\x02\x04\x05\x12\x03H\x02\x08\n\x0c\n\x05\x04\
    \x02\x02\x04\x01\x12\x03H\t\x11\n\x0c\n\x05\x04\x02\x02\x04\x03\x12\x03H\
    \x14\x15\nX\n\x04\x04\x02\x02\x05\x12\x03J\x02\x15\x1aK\x20Model/variant\
    \x20e.g.\x20sdk_gphone_x86_64-userdebug,\x20cf_x86_64_phone-user,\x20etc\
    \n\n\x0c\n\x05\x04\x02\x02\x05\x05\x12\x03J\x02\x08\n\x0c\n\x05\x04\x02\
    \x02\x05\x01\x12\x03J\t\x10\n\x0c\n\x05\x04\x02\x02\x05\x03\x12\x03J\x13\
    \x14\n;\n\x04\x04\x02\x02\x06\x12\x03L\x02\x12\x1a.\x20CPU\x20architectu\
    re\x20e.g.\x20x86_64,\x20arm64-v8a,\x20etc\n\n\x0c\n\x05\x04\x02\x02\x06\
    \x05\x12\x03L\x02\x08\n\x0c\n\x05\x04\x02\x02\x06\x01\x12\x03L\t\r\n\x0c\
    \n\x05\x04\x02\x02\x06\x03\x12\x03L\x10\x11\n\x1f\n\x04\x04\x02\x02\x07\
    \x12\x03N\x02\x16\x1a\x12\x20AVD\x20ini\x20filepath\n\n\x0c\n\x05\x04\
    \x02\x02\x07\x05\x12\x03N\x02\x08\n\x0c\n\x05\x04\x02\x02\x07\x01\x12\
    \x03N\t\x11\n\x0c\n\x05\x04\x02\x02\x07\x03\x12\x03N\x14\x15\n\n\n\x02\
    \x04\x03\x12\x04Q\0k\x01\n\n\n\x03\x04\x03\x01\x12\x03Q\x08\x0c\n\x1f\n\
    \x04\x04\x03\x02\0\x12\x03S\x02\x1b\x1a\x12\x20the\x20kind\x20of\x20chip\
    \n\n\x0c\n\x05\x04\x03\x02\0\x06\x12\x03S\x02\x11\n\x0c\n\x05\x04\x03\
    \x02\0\x01\x12\x03S\x12\x16\n\x0c\n\x05\x04\x03\x02\0\x03\x12\x03S\x19\
    \x1a\n)\n\x04\x04\x03\x02\x01\x12\x03U\x02\x10\x1a\x1c\x20optional\x20li\
    ke\x20\"rear-right\"\n\n\x0c\n\x05\x04\x03\x02\x01\x05\x12\x03U\x02\x08\
    \n\x0c\n\x05\x04\x03\x02\x01\x01\x12\x03U\t\x0b\n\x0c\n\x05\x04\x03\x02\
    \x01\x03\x12\x03U\x0e\x0f\n#\n\x04\x04\x03\x02\x02\x12\x03W\x02\x1a\x1a\
    \x16\x20optional\x20like\x20Quorvo\n\n\x0c\n\x05\x04\x03\x02\x02\x05\x12\
    \x03W\x02\x08\n\x0c\n\x05\x04\x03\x02\x02\x01\x12\x03W\t\x15\n\x0c\n\x05\
    \x04\x03\x02\x02\x03\x12\x03W\x18\x19\n\"\n\x04\x04\x03\x02\x03\x12\x03Y\
    \x02\x1a\x1a\x15\x20optional\x20like\x20DW300\n\n\x0c\n\x05\x04\x03\x02\
    \x03\x05\x12\x03Y\x02\x08\n\x0c\n\x05\x04\x03\x02\x03\x01\x12\x03Y\t\x15\
    \n\x0c\n\x05\x04\x03\x02\x03\x03\x12\x03Y\x18\x19\n&\n\x04\x04\x03\x02\
    \x04\x12\x03[\x02\x12\x1a\x19\x20optional\x20guest\x20os\x20input\n\n\
    \x0c\n\x05\x04\x03\x02\x04\x05\x12\x03[\x02\x07\n\x0c\n\x05\x04\x03\x02\
    \x04\x01\x12\x03[\x08\r\n\x0c\n\x05\x04\x03\x02\x04\x03\x12\x03[\x10\x11\
    \n'\n\x04\x04\x03\x02\x05\x12\x03]\x02\x13\x1a\x1a\x20optional\x20guest\
    \x20os\x20output\n\n\x0c\n\x05\x04\x03\x02\x05\x05\x12\x03]\x02\x07\n\
    \x0c\n\x05\x04\x03\x02\x05\x01\x12\x03]\x08\x0e\n\x0c\n\x05\x04\x03\x02\
    \x05\x03\x12\x03]\x11\x12\n#\n\x04\x04\x03\x02\x06\x12\x03_\x02\x14\x1a\
    \x16\x20optional\x20for\x20testing\n\n\x0c\n\x05\x04\x03\x02\x06\x05\x12\
    \x03_\x02\x06\n\x0c\n\x05\x04\x03\x02\x06\x01\x12\x03_\x07\x0f\n\x0c\n\
    \x05\x04\x03\x02\x06\x03\x12\x03_\x12\x13\n.\n\x04\x04\x03\x02\x07\x12\
    \x03a\x027\x1a!\x20optional\x20for\x20bluetooth\x20chipsets\n\n\x0c\n\
    \x05\x04\x03\x02\x07\x06\x12\x03a\x02$\n\x0c\n\x05\x04\x03\x02\x07\x01\
    \x12\x03a%2\n\x0c\n\x05\x04\x03\x02\x07\x03\x12\x03a56\nS\n\x04\x04\x03\
    \x02\x08\x12\x03d\x02\x15\x1aF\x20address\x20in\x20format\x20xx:xx:xx:xx\
    :xx:xx\n\x20optional\x20for\x20bluetooth\x20chipsets\n\n\x0c\n\x05\x04\
    \x03\x02\x08\x05\x12\x03d\x02\x08\n\x0c\n\x05\x04\x03\x02\x08\x01\x12\
    \x03d\t\x10\n\x0c\n\x05\x04\x03\x02\x08\x03\x12\x03d\x13\x14\n@\n\x04\
    \x04\x03\x02\t\x12\x03f\x02&\x1a3\x20Offset\x20of\x20the\x20chip\x20posi\
    tion\x20from\x20center\x20of\x20device\n\n\x0c\n\x05\x04\x03\x02\t\x04\
    \x12\x03f\x02\n\n\x0c\n\x05\x04\x03\x02\t\x06\x12\x03f\x0b\x19\n\x0c\n\
    \x05\x04\x03\x02\t\x01\x12\x03f\x1a\x20\n\x0c\n\x05\x04\x03\x02\t\x03\
    \x12\x03f#%\nX\n\x04\x04\x03\x02\n\x12\x03h\x02\x16\x1aK\x20Sim\x20type\
    \x20for\x20modem\x20simulator\x20(1\x20for\x20normal,\x202\x20for\x20Cts\
    CarrierApiTestCases)\n\n\x0c\n\x05\x04\x03\x02\n\x05\x12\x03h\x02\x07\n\
    \x0c\n\x05\x04\x03\x02\n\x01\x12\x03h\x08\x10\n\x0c\n\x05\x04\x03\x02\n\
    \x03\x12\x03h\x13\x15\n*\n\x04\x04\x03\x02\x0b\x12\x03j\x02#\x1a\x1d\x20\
    XML\x20SIM\x20ICC\x20profile\x20content\n\n\x0c\n\x05\x04\x03\x02\x0b\
    \x04\x12\x03j\x02\n\n\x0c\n\x05\x04\x03\x02\x0b\x05\x12\x03j\x0b\x11\n\
    \x0c\n\x05\x04\x03\x02\x0b\x01\x12\x03j\x12\x1d\n\x0c\n\x05\x04\x03\x02\
    \x0b\x03\x12\x03j\x20\"b\x06proto3\
";
