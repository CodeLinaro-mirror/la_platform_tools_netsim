...
pub struct ControllerFeatures {
    ...
    // @@protoc_insertion_point(field:rootcanal.configuration.ControllerFeatures.le_power_control_request)
    pub le_power_control_request: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:rootcanal.configuration.ControllerFeatures.le_isochronous_broadcaster)
    pub le_isochronous_broadcaster: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:rootcanal.configuration.ControllerFeatures.le_synchronized_receiver)
    pub le_synchronized_receiver: ::std::option::Option<bool>,
    // special fields
...
impl ControllerFeatures {
    ...
    // optional bool le_power_control_request = 9;

    pub fn le_power_control_request(&self) -> bool {
        self.le_power_control_request.unwrap_or(false)
    }

    pub fn clear_le_power_control_request(&mut self) {
        self.le_power_control_request = ::std::option::Option::None;
    }

    pub fn has_le_power_control_request(&self) -> bool {
        self.le_power_control_request.is_some()
    }

    // Param is passed by value, moved
    pub fn set_le_power_control_request(&mut self, v: bool) {
        self.le_power_control_request = ::std::option::Option::Some(v);
    }

    // optional bool le_isochronous_broadcaster = 10;

    pub fn le_isochronous_broadcaster(&self) -> bool {
        self.le_isochronous_broadcaster.unwrap_or(false)
    }

    pub fn clear_le_isochronous_broadcaster(&mut self) {
        self.le_isochronous_broadcaster = ::std::option::Option::None;
    }

    pub fn has_le_isochronous_broadcaster(&self) -> bool {
        self.le_isochronous_broadcaster.is_some()
    }

    // Param is passed by value, moved
    pub fn set_le_isochronous_broadcaster(&mut self, v: bool) {
        self.le_isochronous_broadcaster = ::std::option::Option::Some(v);
    }

    // optional bool le_synchronized_receiver = 11;

    pub fn le_synchronized_receiver(&self) -> bool {
        self.le_synchronized_receiver.unwrap_or(false)
    }

    pub fn clear_le_synchronized_receiver(&mut self) {
        self.le_synchronized_receiver = ::std::option::Option::None;
    }

    pub fn has_le_synchronized_receiver(&self) -> bool {
        self.le_synchronized_receiver.is_some()
    }

    // Param is passed by value, moved
    pub fn set_le_synchronized_receiver(&mut self, v: bool) {
        self.le_synchronized_receiver = ::std::option::Option::Some(v);
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            ...
            |m: &ControllerFeatures| { &m.le_power_control_request },
            |m: &mut ControllerFeatures| { &mut m.le_power_control_request },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "le_isochronous_broadcaster",
            |m: &ControllerFeatures| { &m.le_isochronous_broadcaster },
            |m: &mut ControllerFeatures| { &mut m.le_isochronous_broadcaster },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "le_synchronized_receiver",
            |m: &ControllerFeatures| { &m.le_synchronized_receiver },
            |m: &mut ControllerFeatures| { &mut m.le_synchronized_receiver },
        ));
...
impl ::protobuf::Message for ControllerFeatures {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                72 => {
                    self.le_power_control_request = ::std::option::Option::Some(is.read_bool()?);
                },
                80 => {
                    self.le_isochronous_broadcaster = ::std::option::Option::Some(is.read_bool()?);
                },
                88 => {
                    self.le_synchronized_receiver = ::std::option::Option::Some(is.read_bool()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.le_power_control_request {
            my_size += 1 + 1;
        }
        if let Some(v) = self.le_isochronous_broadcaster {
            my_size += 1 + 1;
        }
        if let Some(v) = self.le_synchronized_receiver {
            my_size += 1 + 1;
        }
    ...
    fn default_instance() -> &'static ControllerFeatures {
        static instance: ControllerFeatures = ControllerFeatures {
            ...
            le_power_control_request: ::std::option::Option::None,
            le_isochronous_broadcaster: ::std::option::Option::None,
            le_synchronized_receiver: ::std::option::Option::None,
...
impl ::protobuf::Enum for ControllerPreset {
    ...
    fn from_str(str: &str) -> ::std::option::Option<ControllerPreset> {
        match str {
            "DEFAULT" => ::std::option::Option::Some(ControllerPreset::DEFAULT),
            "LAIRD_BL654" => ::std::option::Option::Some(ControllerPreset::LAIRD_BL654),
            "CSR_RCK_PTS_DONGLE" => ::std::option::Option::Some(ControllerPreset::CSR_RCK_PTS_DONGLE),
            "INTEL_BE200" => ::std::option::Option::Some(ControllerPreset::INTEL_BE200),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1drootcanal/configuration.proto\x12\x17rootcanal.configuration\"\xc1\
    ...
    \x18\x08\x20\x01(\x08R\x11leChannelSounding\x127\n\x18le_power_control_r\
    equest\x18\t\x20\x01(\x08R\x15lePowerControlRequest\x12<\n\x1ale_isochro\
    nous_broadcaster\x18\n\x20\x01(\x08R\x18leIsochronousBroadcaster\x128\n\
    \x18le_synchronized_receiver\x18\x0b\x20\x01(\x08R\x16leSynchronizedRece\
    iver\"\xe5\x01\n\x10ControllerQuirks\x12U\n(send_acl_data_before_connect\
    ion_complete\x18\x01\x20\x01(\x08R#sendAclDataBeforeConnectionComplete\
    \x12;\n\x1ahas_default_random_address\x18\x02\x20\x01(\x08R\x17hasDefaul\
    tRandomAddress\x12=\n\x1bhardware_error_before_reset\x18\x03\x20\x01(\
    \x08R\x18hardwareErrorBeforeReset\"<\n\x0eVendorFeatures\x12\x10\n\x03cs\
    r\x18\x01\x20\x01(\x08R\x03csr\x12\x18\n\x07android\x18\x02\x20\x01(\x08\
    R\x07android\"\xb4\x02\n\nController\x12A\n\x06preset\x18\x01\x20\x01(\
    \x0e2).rootcanal.configuration.ControllerPresetR\x06preset\x12G\n\x08fea\
    tures\x18\x02\x20\x01(\x0b2+.rootcanal.configuration.ControllerFeaturesR\
    \x08features\x12A\n\x06quirks\x18\x03\x20\x01(\x0b2).rootcanal.configura\
    tion.ControllerQuirksR\x06quirks\x12\x16\n\x06strict\x18\x04\x20\x01(\
    \x08R\x06strict\x12?\n\x06vendor\x18\x05\x20\x01(\x0b2'.rootcanal.config\
    uration.VendorFeaturesR\x06vendor\"q\n\tTcpServer\x12\x19\n\x08tcp_port\
    \x18\x01\x20\x02(\x05R\x07tcpPort\x12I\n\rconfiguration\x18\x02\x20\x01(\
    \x0b2#.rootcanal.configuration.ControllerR\rconfiguration\"R\n\rConfigur\
    ation\x12A\n\ntcp_server\x18\x01\x20\x03(\x0b2\".rootcanal.configuration\
    .TcpServerR\ttcpServer*Y\n\x10ControllerPreset\x12\x0b\n\x07DEFAULT\x10\
    \0\x12\x0f\n\x0bLAIRD_BL654\x10\x01\x12\x16\n\x12CSR_RCK_PTS_DONGLE\x10\
    \x02\x12\x0f\n\x0bINTEL_BE200\x10\x03B\x02H\x02J\xee\x1f\n\x06\x12\x04\
    ...
    nse\x20at\n\n\x20\x20\x20\x20\x20https://www.apache.org/licenses/LICENSE\
    -2.0\n\n\x20Unless\x20required\x20by\x20applicable\x20law\x20or\x20agree\
    ...
    \n\x08\n\x01\x08\x12\x03\x11\0\x20\n\t\n\x02\x08\t\x12\x03\x11\0\x20\n\n\
    \n\x02\x05\0\x12\x04\x13\0\x1c\x01\n\n\n\x03\x05\0\x01\x12\x03\x13\x05\
    \x15\nF\n\x04\x05\0\x02\0\x12\x03\x15\x02\x0e\x1a9\x20Version\x205.3,\
    \x20all\x20features\x20enabled,\x20all\x20quirks\x20disabled.\n\n\x0c\n\
    \x05\x05\0\x02\0\x01\x12\x03\x15\x02\t\n\x0c\n\x05\x05\0\x02\0\x02\x12\
    \x03\x15\x0c\r\n0\n\x04\x05\0\x02\x01\x12\x03\x17\x02\x12\x1a#\x20Offici\
    al\x20PTS\x20dongle,\x20Laird\x20BL654.\n\n\x0c\n\x05\x05\0\x02\x01\x01\
    \x12\x03\x17\x02\r\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03\x17\x10\x11\n,\
    \n\x04\x05\0\x02\x02\x12\x03\x19\x02\x19\x1a\x1f\x20Official\x20PTS\x20d\
    ongle,\x20CSR\x20rck.\n\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03\x19\x02\
    \x14\n\x0c\n\x05\x05\0\x02\x02\x02\x12\x03\x19\x17\x18\n0\n\x04\x05\0\
    \x02\x03\x12\x03\x1b\x02\x12\x1a#\x20Official\x20PTS\x20dongle,\x20Intel\
    \x20BE200.\n\n\x0c\n\x05\x05\0\x02\x03\x01\x12\x03\x1b\x02\r\n\x0c\n\x05\
    \x05\0\x02\x03\x02\x12\x03\x1b\x10\x11\n\n\n\x02\x04\0\x12\x04\x1e\0,\
    \x01\n\n\n\x03\x04\0\x01\x12\x03\x1e\x08\x1a\n\x0b\n\x04\x04\0\x02\0\x12\
    \x03\x1f\x02,\n\x0c\n\x05\x04\0\x02\0\x04\x12\x03\x1f\x02\n\n\x0c\n\x05\
    \x04\0\x02\0\x05\x12\x03\x1f\x0b\x0f\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\
    \x1f\x10'\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\x1f*+\n\x0b\n\x04\x04\0\
    \x02\x01\x12\x03\x20\x02,\n\x0c\n\x05\x04\0\x02\x01\x04\x12\x03\x20\x02\
    \n\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03\x20\x0b\x0f\n\x0c\n\x05\x04\0\
    \x02\x01\x01\x12\x03\x20\x10'\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\x20*\
    ...
    \0\x02\x04\x05\x12\x03#\x0b\x0f\n\x0c\n\x05\x04\0\x02\x04\x01\x12\x03#\
    \x10\x1c\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03#\x1f\x20\n\x83\x01\n\x04\
    \x04\0\x02\x05\x12\x03&\x024\x1av\x20Enable\x20the\x20support\x20for\x20\
    both\x20LL\x20Connected\x20Isochronous\x20Stream\x20Central\n\x20and\x20\
    LL\x20Connected\x20Isochronous\x20Stream\x20Peripheral.\n\n\x0c\n\x05\
    \x04\0\x02\x05\x04\x12\x03&\x02\n\n\x0c\n\x05\x04\0\x02\x05\x05\x12\x03&\
    \x0b\x0f\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x03&\x10/\n\x0c\n\x05\x04\0\
    \x02\x05\x03\x12\x03&23\n\x0b\n\x04\x04\0\x02\x06\x12\x03'\x02,\n\x0c\n\
    ...
    \x04\x01\x01\x12\x03.\x08\x18\nj\n\x04\x04\x01\x02\0\x12\x031\x02=\x1a]\
    \x20Randomly\x20send\x20ACL\x20payloads\x20before\x20the\x20Connection\
    \x20Complete\x20event\n\x20is\x20sent\x20to\x20the\x20Host\x20stack.\n\n\
    \x0c\n\x05\x04\x01\x02\0\x04\x12\x031\x02\n\n\x0c\n\x05\x04\x01\x02\0\
    \x05\x12\x031\x0b\x0f\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x031\x108\n\x0c\
    \n\x05\x04\x01\x02\0\x03\x12\x031;<\nC\n\x04\x04\x01\x02\x01\x12\x033\
    \x02/\x1a6\x20Configure\x20a\x20default\x20value\x20for\x20the\x20LE\x20\
    random\x20address.\n\n\x0c\n\x05\x04\x01\x02\x01\x04\x12\x033\x02\n\n\
    \x0c\n\x05\x04\x01\x02\x01\x05\x12\x033\x0b\x0f\n\x0c\n\x05\x04\x01\x02\
    \x01\x01\x12\x033\x10*\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x033-.\nV\n\
    \x04\x04\x01\x02\x02\x12\x035\x020\x1aI\x20Send\x20an\x20Hardware\x20Err\
    or\x20event\x20if\x20any\x20command\x20is\x20called\x20before\x20HCI\x20\
    Reset.\n\n\x0c\n\x05\x04\x01\x02\x02\x04\x12\x035\x02\n\n\x0c\n\x05\x04\
    \x01\x02\x02\x05\x12\x035\x0b\x0f\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\
    \x035\x10+\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\x035./\n\n\n\x02\x04\x02\
    \x12\x048\0@\x01\n\n\n\x03\x04\x02\x01\x12\x038\x08\x16\n=\n\x04\x04\x02\
    \x02\0\x12\x03:\x02\x18\x1a0\x20Enable\x20the\x20support\x20for\x20the\
    \x20CSR\x20vendor\x20command.\n\n\x0c\n\x05\x04\x02\x02\0\x04\x12\x03:\
    \x02\n\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03:\x0b\x0f\n\x0c\n\x05\x04\
    \x02\x02\0\x01\x12\x03:\x10\x13\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03:\
    \x16\x17\n\x89\x02\n\x04\x04\x02\x02\x01\x12\x03?\x02\x1c\x1a\xfb\x01\
    \x20Enable\x20the\x20support\x20for\x20Android\x20vendor\x20commands.\n\
    \x20Note:\x20not\x20all\x20required\x20vendor\x20commands\x20are\x20nece\
    ssarily\x20implemented\n\x20in\x20RootCanal,\x20unimplemented\x20command\
    s\x20will\x20return\x20a\x20Command\x20Status\x20or\n\x20Command\x20Comp\
    lete\x20HCI\x20event\x20with\x20the\x20status\x20Unsupported\x20Opcode.\
    \n\n\x0c\n\x05\x04\x02\x02\x01\x04\x12\x03?\x02\n\n\x0c\n\x05\x04\x02\
    \x02\x01\x05\x12\x03?\x0b\x0f\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03?\
    \x10\x17\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03?\x1a\x1b\n\n\n\x02\x04\
    \x03\x12\x04B\0R\x01\n\n\n\x03\x04\x03\x01\x12\x03B\x08\x12\n\x9d\x01\n\
    \x04\x04\x03\x02\0\x12\x03E\x02'\x1a\x8f\x01\x20Configure\x20the\x20cont\
    roller\x20preset.\x20Presets\x20come\x20with\x20a\x20pre-selection\n\x20\
    of\x20features\x20and\x20quirks,\x20but\x20these\x20can\x20be\x20overrid\
    den\x20with\x20the\x20next\x20fields.\n\n\x0c\n\x05\x04\x03\x02\0\x04\
    \x12\x03E\x02\n\n\x0c\n\x05\x04\x03\x02\0\x06\x12\x03E\x0b\x1b\n\x0c\n\
    \x05\x04\x03\x02\0\x01\x12\x03E\x1c\"\n\x0c\n\x05\x04\x03\x02\0\x03\x12\
    \x03E%&\n9\n\x04\x04\x03\x02\x01\x12\x03G\x02+\x1a,\x20Configure\x20supp\
    ort\x20for\x20controller\x20features.\n\n\x0c\n\x05\x04\x03\x02\x01\x04\
    \x12\x03G\x02\n\n\x0c\n\x05\x04\x03\x02\x01\x06\x12\x03G\x0b\x1d\n\x0c\n\
    \x05\x04\x03\x02\x01\x01\x12\x03G\x1e&\n\x0c\n\x05\x04\x03\x02\x01\x03\
    \x12\x03G)*\n\x90\x01\n\x04\x04\x03\x02\x02\x12\x03K\x02'\x1a\x82\x01\
    \x20Enable\x20controller\x20quirks.\n\x20Quirks\x20are\x20behaviors\x20o\
    bserved\x20in\x20real\x20controllers\x20that\x20are\x20not\x20valid\n\
    \x20according\x20to\x20the\x20specification.\n\n\x0c\n\x05\x04\x03\x02\
    \x02\x04\x12\x03K\x02\n\n\x0c\n\x05\x04\x03\x02\x02\x06\x12\x03K\x0b\x1b\
    \n\x0c\n\x05\x04\x03\x02\x02\x01\x12\x03K\x1c\"\n\x0c\n\x05\x04\x03\x02\
    \x02\x03\x12\x03K%&\n\x9c\x01\n\x04\x04\x03\x02\x03\x12\x03O\x02\x1b\x1a\
    \x8e\x01\x20Enable\x20strict\x20mode\x20(defaults\x20to\x20enabled).\n\
    \x20Activate\x20assertion\x20checks\x20in\x20RootCanal\x20for\x20missing\
    \x20RootCanal\x20features\n\x20or\x20Host\x20stack\x20misbehavior.\n\n\
    \x0c\n\x05\x04\x03\x02\x03\x04\x12\x03O\x02\n\n\x0c\n\x05\x04\x03\x02\
    \x03\x05\x12\x03O\x0b\x0f\n\x0c\n\x05\x04\x03\x02\x03\x01\x12\x03O\x10\
    \x16\n\x0c\n\x05\x04\x03\x02\x03\x03\x12\x03O\x19\x1a\n5\n\x04\x04\x03\
    \x02\x04\x12\x03Q\x02%\x1a(\x20Configure\x20support\x20for\x20vendor\x20\
    features.\n\n\x0c\n\x05\x04\x03\x02\x04\x04\x12\x03Q\x02\n\n\x0c\n\x05\
    \x04\x03\x02\x04\x06\x12\x03Q\x0b\x19\n\x0c\n\x05\x04\x03\x02\x04\x01\
    \x12\x03Q\x1a\x20\n\x0c\n\x05\x04\x03\x02\x04\x03\x12\x03Q#$\n\n\n\x02\
    \x04\x04\x12\x04T\0Z\x01\n\n\n\x03\x04\x04\x01\x12\x03T\x08\x11\nn\n\x04\
    \x04\x04\x02\0\x12\x03W\x02\x1e\x1aa\x20Configure\x20the\x20TCP\x20port\
    \x20on\x20which\x20the\x20controller\x20with\x20this\x20defined\n\x20con\
    figuration\x20will\x20be\x20served.\n\n\x0c\n\x05\x04\x04\x02\0\x04\x12\
    \x03W\x02\n\n\x0c\n\x05\x04\x04\x02\0\x05\x12\x03W\x0b\x10\n\x0c\n\x05\
    \x04\x04\x02\0\x01\x12\x03W\x11\x19\n\x0c\n\x05\x04\x04\x02\0\x03\x12\
    \x03W\x1c\x1d\n6\n\x04\x04\x04\x02\x01\x12\x03Y\x02(\x1a)\x20Controller\
    \x20configuration\x20for\x20this\x20port.\n\n\x0c\n\x05\x04\x04\x02\x01\
    \x04\x12\x03Y\x02\n\n\x0c\n\x05\x04\x04\x02\x01\x06\x12\x03Y\x0b\x15\n\
    \x0c\n\x05\x04\x04\x02\x01\x01\x12\x03Y\x16#\n\x0c\n\x05\x04\x04\x02\x01\
    \x03\x12\x03Y&'\n\n\n\x02\x04\x05\x12\x04\\\0^\x01\n\n\n\x03\x04\x05\x01\
    \x12\x03\\\x08\x15\n\x0b\n\x04\x04\x05\x02\0\x12\x03]\x02$\n\x0c\n\x05\
    \x04\x05\x02\0\x04\x12\x03]\x02\n\n\x0c\n\x05\x04\x05\x02\0\x06\x12\x03]\
    \x0b\x14\n\x0c\n\x05\x04\x05\x02\0\x01\x12\x03]\x15\x1f\n\x0c\n\x05\x04\
