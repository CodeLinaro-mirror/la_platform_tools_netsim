...
#[repr(C)]
#[derive(
    Debug, Copy, Clone, FromBytes, IntoBytes, Unaligned, Immutable, KnownLayout, PartialEq, Eq,
)]
...
impl NlAttrHdr {
    ...
    /// Gets the type of the attribute (alias for attr_type).
    pub fn type_(&self) -> u16 {
        self.attr_type.get()
    }

    /// Decodes a full `NlAttrHdr` from bytes.
