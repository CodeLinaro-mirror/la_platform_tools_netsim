...
- **RQ-STATS-09**: **Universal Stats Support**: All registered Chip Actors must implement the `GetStatistics` command. If no stats are available, they must return an empty list rather than failing or timing out.
