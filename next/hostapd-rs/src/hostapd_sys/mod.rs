...
//!
//! This module allows interaction with hostapd's core functionalities directly
//! from Rust code.
//!
//! ## Usage
//!
//! This module provides a function to start the hostapd process and includes
...
//! ### Platform-Specific Bindings
//!
//! This module provides bindings automatically generated by `rust-bindgen` for
...
//!
//! These bindings expose constants, structures, and functions specific to each
//! platform, allowing you to interact with the underlying hostapd
//! implementation.
//!
//! **Example (Linux):**
//!
//! This example demonstrates how to access the active Pairwise Transient Key
//! (PTK) from hostapd on Linux.
//!
//! ```
//! # #[cfg(target_os = "linux")]
//! # fn main() {
