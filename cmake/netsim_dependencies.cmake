...
if(WINDOWS_MSVC_X86_64)
  add_cxx_flag("-DWIN32")
  add_cxx_flag("-D_WINDOWS")
  add_cxx_flag("-D_NO_EXCEPTIONS")
  add_cxx_flag("-D_GNU_SOURCE")
  ...
  add_cxx_flag("-D_FILE_OFFSET_BITS=64")
  add_cxx_flag("-D_LARGEFILE_SOURCE")
  add_cxx_flag("-D_LIBCPP_VERSION=__GLIBCPP__")
  add_cxx_flag("-D__STDC_CONSTANT_MACROS")
  add_cxx_flag("-D__STDC_FORMAT_MACROS=1")
  add_cxx_flag("-D__STDC_LIMIT_MACROS=1")
  add_cxx_flag("-D_GNU_SOURCE=1")
endif()
# Compiler Options and Warning SuppressionW,-f)
add_cxx_flag("-Wno-everything")
...
add_subdirectory(${AOSP}/tools/rootcanal rootcanal)
